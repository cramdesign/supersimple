						...
						<div class="meta comment-meta">
							...
							<p class="name">
								<?php 
									...
									/* 2 */ ( $comment->user_id === $post->post_author ) ? '<span>Post author</span>' : '' );
							...
							<p class="time">
								<?php
									...
									printf( '<a href="%1$s"><time datetime="%2$s">%3$s</time></a>',
 									/* 1 */ esc_url( get_comment_link( $comment->comment_ID ) ),
									/* 2 */ get_comment_time( 'c' ),
									/* 3 */ sprintf( '%1$s at %2$s', get_comment_date( 'm/d/y' ), get_comment_time() ) );
